...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="lbl_codigo" runat="server" CssClass="badge" Text="Carné"></asp:Label>
    ...
    <asp:Label ID="lbl_ce" runat="server" CssClass="badge" Text="Correo Electronico"></asp:Label>
    <asp:TextBox ID="txt_ce" runat="server" CssClass="form-control"></asp:TextBox>
    <asp:Label ID="lbl_ts" runat="server" CssClass="badge" Text="Tipo de Sangre"></asp:Label>
    <asp:DropDownList ID="drop_ts" runat="server" CssClass="form-control"></asp:DropDownList>
